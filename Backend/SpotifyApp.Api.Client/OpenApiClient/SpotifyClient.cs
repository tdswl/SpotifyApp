...
#pragma warning disable 8765 // Disable "CS8765 Nullability of type of parameter doesn't match overridden member (possibly because of nullability attributes)."
    ...
    public virtual async System.Threading.Tasks.Task<Response8> SearchAsync(string q, System.Collections.Generic.IEnumerable<Anonymous> type, string market, int? limit, int? offset, Include_external? include_external, System.Threading.CancellationToken cancellationToken)
    {
        if (q == null)
